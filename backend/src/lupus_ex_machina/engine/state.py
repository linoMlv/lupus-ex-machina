...
What a round *played* — its ballots, its night choices, its speeches — is in
:mod:`records`; this is what the game currently is.
"""
...
from lupus_ex_machina.engine.records import (
    Ballot,
    NightChoice,
    PriorityShare,
    Speech,
