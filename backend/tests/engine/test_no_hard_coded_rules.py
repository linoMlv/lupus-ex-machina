...
ALLOWED: dict[str, str] = {
    ...
    "validation.turn.BOOTSTRAP_DAY": "Day 1 is a rule of the bootstrap (D-032), not a length",
    "validation.actor.ACTIONABLE_PHASES": "which phases take an intent at all — structure",
    "validation.__all__": "what the package exports, not a value a game holds",
